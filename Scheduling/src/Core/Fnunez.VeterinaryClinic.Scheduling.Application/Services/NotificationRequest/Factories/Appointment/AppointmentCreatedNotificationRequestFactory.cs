...
public class AppointmentCreatedNotificationRequestFactory
    : INotificationRequestFactory
{
    ...
    public AppointmentCreatedNotificationRequestFactory(
    ...
    {
        return NotificationEvent.AppointmentCreated.ToString();
    }
}
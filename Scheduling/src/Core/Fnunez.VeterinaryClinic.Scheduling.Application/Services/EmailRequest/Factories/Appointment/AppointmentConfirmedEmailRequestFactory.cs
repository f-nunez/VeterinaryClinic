...
public class AppointmentConfirmedEmailRequestFactory : IEmailRequestFactory
{
    private readonly Appointment _appointment;
    private readonly Guid _correlationId;
    private readonly string? _userId;

    public AppointmentConfirmedEmailRequestFactory(
    ...
    {
        return new AppointmentConfirmedEmailRequest
        {
    ...
    {
        return EmailEvent.AppointmentConfirmed.ToString();
    }
}
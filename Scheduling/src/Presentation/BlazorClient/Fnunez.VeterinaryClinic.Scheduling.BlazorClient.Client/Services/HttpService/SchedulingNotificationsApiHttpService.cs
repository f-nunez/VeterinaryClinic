...
public class SchedulingNotificationsApiHttpService
    : ISchedulingNotificationsApiHttpService
{
    private readonly string _reverseProxyRoute;
    private readonly HttpClient _httpClient;

    public SchedulingNotificationsApiHttpService(
        ...
        HttpClient httpClient)
    {
        ...
        _reverseProxyRoute = bffSetting.SuffixRouteForSchedulingNotificationsApi;
    }

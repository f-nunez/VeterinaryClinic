...
namespace Fnunez.VeterinaryClinic.Scheduling.Application.IntegrationTests.Features.Doctors.Queries.GetDoctorsFilterFullName;
    ...
    : IClassFixture<TestContextFixture>
{
    ...
    public GetDoctorsFilterFullNameQueryHandlerTests(

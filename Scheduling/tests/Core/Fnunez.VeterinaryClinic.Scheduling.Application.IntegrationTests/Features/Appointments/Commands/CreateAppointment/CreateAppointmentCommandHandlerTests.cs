...
namespace Fnunez.VeterinaryClinic.Scheduling.Application.IntegrationTests.Features.Appointments.Commands.CreateAppointment;
    ...
    : IClassFixture<TestContextFixture>
{
    ...
    public CreateAppointmentCommandHandlerTests(TestContextFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    [Fact]
    public async Task Handle_ReturnsCreateAppointmentResponse()
    {
        // Arrange
        ...
        Assert.IsType<CreateAppointmentResponse>(actual);

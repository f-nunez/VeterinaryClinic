...
namespace Fnunez.VeterinaryClinic.Scheduling.Application.IntegrationTests.Features.Appointments.Commands.UpdateAppointment;
    ...
    : IClassFixture<TestContextFixture>
{
    ...
    public UpdateAppointmentCommandHandlerTests(TestContextFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    [Fact]
    public async Task Handle_ReturnsUpdateAppointmentResponse()
    {
        // Arrange
        ...
        appointmentDescription = "new description";

        appointmentEndOn = appointmentEndOn.AddHours(1);

        appointmentStartOn = appointmentStartOn.AddHours(1);

        appointmentTitle = "new title";
        ...
        var request = new UpdateAppointmentRequest
        {
            ...
            DoctorId = doctor.Id,
            EndOn = appointmentEndOn,
            RoomId = room.Id,
            StartOn = appointmentStartOn,
        ...
        Assert.IsType<UpdateAppointmentResponse>(actual);

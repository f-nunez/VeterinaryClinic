...
namespace Fnunez.VeterinaryClinic.Scheduling.Application.IntegrationTests.Features.Appointments.Queries.GetAppointmentDetail;
    ...
    : IClassFixture<TestContextFixture>
{
    ...
    public GetAppointmentDetailQueryHandlerTests(TestContextFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    [Fact]
    public async Task Handle_ReturnsGetAppointmentDetailResponse()
    {
        // Arrange
        ...
        Assert.IsType<GetAppointmentDetailResponse>(actual);

        Assert.NotNull(actual.Appointment);

        Assert.Equal(appointment.Id, actual.Appointment.AppointmentId);

        Assert.Equal(appointmentType.Name, actual.Appointment.AppointmentTypeName);

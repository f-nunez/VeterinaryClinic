...
public class GetAppointmentsFilterDoctorQueryHandlerValidatorTests
{
    private readonly GetAppointmentsFilterDoctorQueryHandlerValidator _validator;

    public GetAppointmentsFilterDoctorQueryHandlerValidatorTests()
    {
        _validator = new();
    }
    ...
    public void Validation_DataGridRequestSearchHasMoreThanTwoHundredCharacters_Fails()
    {
        ...
        validationResult.ShouldHaveValidationErrorFor(x =>
            x.GetAppointmentsFilterDoctorRequest.DataGridRequest.Search);
    }
    ...
    public void Validation_DataGridRequestSkipIsLessThanZero_Fails()
    {
        ...
        // Assert
        validationResult.ShouldHaveValidationErrorFor(x =>
            x.GetAppointmentsFilterDoctorRequest.DataGridRequest.Skip);
    }
    ...
    public void Validation_DataGridRequestTakeIsGreaterThanOnehundred_Fails()
    {
        ...
        // Assert
        validationResult.ShouldHaveValidationErrorFor(x =>
            x.GetAppointmentsFilterDoctorRequest.DataGridRequest.Take);
    }

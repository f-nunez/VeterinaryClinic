...
namespace Fnunez.VeterinaryClinic.Scheduling.Application.UnitTests.Features.Appointments.Queries.GetAppointmentsFilterAppointmentType;

public class GetAppointmentsFilterAppointmentTypeQueryValidatorTests
{
    private readonly GetAppointmentsFilterAppointmentTypeQueryValidator _validator;

    public GetAppointmentsFilterAppointmentTypeQueryValidatorTests()
    {
        _validator = new();
    }
    ...
    public void Validation_DataGridRequestSearchHasMoreThanTwoHundredCharacters_Fails()
    {
        ...
        validationResult.ShouldHaveValidationErrorFor(x =>
            x.GetAppointmentsFilterAppointmentTypeRequest.DataGridRequest.Search);
    }
    ...
    public void Validation_DataGridRequestSkipIsLessThanZero_Fails()
    {
        ...
        // Assert
        validationResult.ShouldHaveValidationErrorFor(x =>
            x.GetAppointmentsFilterAppointmentTypeRequest.DataGridRequest.Skip);
    }
    ...
    public void Validation_DataGridRequestTakeIsGreaterThanOnehundred_Fails()
    {
        ...
        // Assert
        validationResult.ShouldHaveValidationErrorFor(x =>
            x.GetAppointmentsFilterAppointmentTypeRequest.DataGridRequest.Take);
    }

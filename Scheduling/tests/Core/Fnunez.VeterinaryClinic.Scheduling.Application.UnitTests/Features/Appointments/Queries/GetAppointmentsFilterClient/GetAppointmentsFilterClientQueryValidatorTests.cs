...
namespace Fnunez.VeterinaryClinic.Scheduling.Application.UnitTests.Features.Appointments.Queries.GetAppointmentsFilterClient;

public class GetAppointmentsFilterClientQueryValidatorTests
{
    private readonly GetAppointmentsFilterClientQueryValidator _validator;

    public GetAppointmentsFilterClientQueryValidatorTests()
    {
        _validator = new();
    }
    ...
    public void Validation_DataGridRequestSearchHasMoreThanTwoHundredCharacters_Fails()
    {
        ...
        validationResult.ShouldHaveValidationErrorFor(x =>
            x.GetAppointmentsFilterClientRequest.DataGridRequest.Search);
    }
    ...
    public void Validation_DataGridRequestSkipIsLessThanZero_Fails()
    {
        ...
        // Assert
        validationResult.ShouldHaveValidationErrorFor(x =>
            x.GetAppointmentsFilterClientRequest.DataGridRequest.Skip);
    }
    ...
    public void Validation_DataGridRequestTakeIsGreaterThanOnehundred_Fails()
    {
        ...
        // Assert
        validationResult.ShouldHaveValidationErrorFor(x =>
            x.GetAppointmentsFilterClientRequest.DataGridRequest.Take);
    }

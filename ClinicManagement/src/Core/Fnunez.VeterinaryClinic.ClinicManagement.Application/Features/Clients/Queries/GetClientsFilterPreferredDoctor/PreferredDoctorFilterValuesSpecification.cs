    ...
    : BaseSpecification<Doctor, PreferredDoctorFilterValueDto>
{
    ...
    private void ApplyFilterSearch(GetClientsFilterPreferredDoctorRequest request)
    {
    ...
    private void ApplyOrder(GetClientsFilterPreferredDoctorRequest request)
    {
        DataGridRequest dataGridRequest = request.DataGridRequest;
    ...
    private void ApplySkipAndTake(GetClientsFilterPreferredDoctorRequest request)
    {
        Query

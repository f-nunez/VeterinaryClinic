...
public class RoomDeletedNotificationRequestFactory
    : INotificationRequestFactory
{
    ...
    public RoomDeletedNotificationRequestFactory(
        Room room,
        Guid correlationId,
        string? userId)
    {
    ...
    {
        return new RoomDeletedNotificationRequest
        {
    ...
    {
        return NotificationEvent.RoomDeleted.ToString();
    }
}
...
public class AppointmentTypeCreatedNotificationRequestFactory
    : INotificationRequestFactory
{
    ...
    public AppointmentTypeCreatedNotificationRequestFactory(
    ...
    {
        return new AppointmentTypeCreatedNotificationRequest
        {
    ...
    {
        return NotificationEvent.AppointmentTypeCreated.ToString();
    }
}
...
public class ClinicManagementApiHttpService : IClinicManagementApiHttpService
{
    private readonly string _reverseProxyRoute;
    private readonly HttpClient _httpClient;

    public ClinicManagementApiHttpService(
        ...
        HttpClient httpClient)
    {
        ...
        _reverseProxyRoute = bffSetting.SuffixRouteForClinicManagementApi;
    }

    ...
    : BaseAppNotificationListItemFactory, IAppNotificationListItemFactory
{
        ...
        IStringLocalizer<AppNotificationComponent> stringLocalizer)
    {
        ...
        return string.Format(
            stringLocalizer["Event_RoomUpdated_Message"],
            _payload.Name,

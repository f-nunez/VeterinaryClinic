...
namespace Fnunez.VeterinaryClinic.ClinicManagement.Application.UnitTests.Features.Doctors.Queries.GetDoctorById;
...
public class GetDoctorByIdQueryValidatorTests
{
    ...
    [InlineData(0)]
    [InlineData(-1)]
    public void Valdiation_IdIsLessOrEqualsThanZero_Fails(int id)
    {
        // Arrange
        var request = new GetDoctorByIdRequest { Id = id };
